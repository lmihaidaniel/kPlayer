import __style__ from './player.sss';
/*@@@@*/
...
export default class Player extends Video {
	constructor(settings) {
		...
		this.device = device;
		this.iframe = inFrame();
		addClass(settings.el, "kml" + capitalizeFirstLetter(settings.el.nodeName.toLowerCase()));
		...
		//initPageVisibility
		this.pageVisibility = new pageVisibility(settings.el);
